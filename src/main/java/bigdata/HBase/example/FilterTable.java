...
public class FilterTable {
    ...
    public void scanFilterTableData() {
        ...
        try {
            ...
            SingleColumnValueFilter filter1 = new SingleColumnValueFilter(Bytes.toBytes("personalinfo"), Bytes.toBytes("gender"), CompareFilter.CompareOp.EQUAL, Bytes.toBytes("F"));
            SingleColumnValueFilter filter2 = new SingleColumnValueFilter(Bytes.toBytes("personalinfo"), Bytes.toBytes("age"), CompareFilter.CompareOp.EQUAL, Bytes.toBytes("25"));
